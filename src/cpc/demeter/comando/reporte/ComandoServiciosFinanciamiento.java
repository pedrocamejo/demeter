...
public class ComandoServiciosFinanciamiento implements IComando, EventListener {
	...
	public void menuImprimir() throws ExcFiltroExcepcion {
		...
		vistaReporte.setTitle("Servicios por financiamiento");
	...
	public void mostrarDialogoDeFechas() throws ExcFiltroExcepcion {
		...
		// vistaReporte.setOtro("Tipo financiamiento:",
