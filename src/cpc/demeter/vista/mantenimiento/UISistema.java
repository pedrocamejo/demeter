...
public class UISistema extends CompVentanaBase<Sistema> {
	...
	public UISistema(String titulo, int ancho, AppDemeter app) {
		super(titulo, ancho);
		this.app = app;
	}

	public void cargarValores(Sistema arg0) throws ExcDatosInvalidos {
