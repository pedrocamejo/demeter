...
public class UIImplementoImpropio extends CompVentanaBase<ImplementoImpropio> {
	...
	public UIImplementoImpropio(String titulo, int ancho, AppDemeter app, List<Marca> marcas , List<Categoria> categorias, List<UnidadFuncional> 	unidades ) 
	{
	...
	@Override
	public void cargarValores(ImplementoImpropio arg0) throws ExcDatosInvalidos {
		...
		if(getModelo().getImplementoUnidad().getUnidad() != null)
		{
			Comboitem item = new Comboitem();
			item.setValue(getModelo().getImplementoUnidad().getUnidad());
			item.setLabel(getModelo().getImplementoUnidad().getUnidad().getStrUbicacion());
			item.setDescription(getModelo().getImplementoUnidad().getUnidad().getDescripcion() );
