...
public class ComandoSolicitud implements IComando, EventListener {
	...
	public void menuImprimir() throws ExcFiltroExcepcion {
		...
		vistaReporte.setTitle("Solicitudes");
		// vistaReporte.setOtro("Sector:", new PerSector().getAll());
