...
import cpc.demeter.controlador.mantenimiento.ContCotizacionEquipo;
...
public class ContCotizacionesEquipo extends ContCatalogo<Cotizacion>
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2419243284593943205L;
	private AppDemeter app;
	private NegocioCotizacion negocioCotizacion;

	public  ContCotizacionesEquipo (AccionFuncionalidad accionesValidas,
		...
		dibujar(accionesValidas, "COTIZACIONES De Equipos",
				negocioCotizacion.getCotizacionesExpedienteEquipos(), app);
		this.app = app;
	}
	...
	public void onEvent(Event event) throws Exception {
		try {
			...
			int dd = Accion.AGREGAR;
			int ss3 = Accion.EDITAR;
			int ss4 = Accion.ASOCIAR;
			if (accion <= Accion.CONSULTAR || accion == Accion.ANULAR
				...
				new ContCotizacionEquipo(accion, cotizacion, this, this.app);
	...
	public void imprimir(Cotizacion cotizacion) {
		try {
			...
			reporte.setSrc("reportes/CotizacionEquipo.jasper");
