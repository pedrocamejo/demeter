...
public class ComandoProductosFacturados implements IComando, EventListener {
	...
	public void menuImprimir() throws ExcFiltroExcepcion {
		...
		vistaReporte.setTitle("Productos Facturados");
	...
	public void imprimir() {
		try {
			...
			JRDataSource ds = new JRBeanCollectionDataSource(
					negocio.getProductosFacturados2(inicio, fin));
			app.agregarReporte();
			Jasperreport reporte = app.getReporte();
			//reporte.setSrc("reportes/listadoProductosFacturados.jasper");
			reporte.setSrc("reportes/listadoProductosFacturados2.jasper");
