...
import cpc.demeter.catalogo.ContNotasDebitos;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoNotaDebito implements IComando {
	...
	public void ejecutar() {
		try {
			ContNotasDebitos servicio = new ContNotasDebitos(getAccionFuncionalidad(), (AppDemeter) app);
