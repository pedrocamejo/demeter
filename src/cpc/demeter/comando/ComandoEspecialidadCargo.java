...
import cpc.demeter.catalogo.ContEspecialidadCargos;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoEspecialidadCargo implements IComando {
	...
	public void ejecutar() {
		...
		try {
			ContEspecialidadCargos servicio = new ContEspecialidadCargos(
