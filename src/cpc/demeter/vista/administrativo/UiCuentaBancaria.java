...
public class UiCuentaBancaria extends CompVentanaBase<CuentaBancaria> {
	...
	public UiCuentaBancaria(String titulo, int ancho, List<Banco> bancos,
	...
	public UiCuentaBancaria(String titulo) throws ExcDatosInvalidos {
		super(titulo);
	...
	public void inicializar() {
		...
		banco.setReadonly(true);
		cuentaContable.setReadonly(true);
		tipoCuenta.setReadonly(true);
	}
	...
	public CompCombobox<Banco> getBanco() {
		return banco;
	}

	public void setBanco(CompCombobox<Banco> banco) {
		this.banco = banco;
	}

	public CompCombobox<TipoCuenta> getTipoCuenta() {
		return tipoCuenta;
	}

	public void setTipoCuenta(CompCombobox<TipoCuenta> tipoCuenta) {
		this.tipoCuenta = tipoCuenta;
	}

	public CompCombobox<CuentaContable> getCuentaContable() {
		return cuentaContable;
	}

	public void setCuentaContable(CompCombobox<CuentaContable> cuentaContable) {
