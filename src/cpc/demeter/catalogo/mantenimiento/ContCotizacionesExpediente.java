...
import cpc.demeter.controlador.mantenimiento.ContCotizacionExpediente;
...
public class ContCotizacionesExpediente extends ContCatalogo<Cotizacion>
	...
	public ContCotizacionesExpediente(AccionFuncionalidad accionesValidas,
		...
		dibujar(accionesValidas, "COTIZACIONES",
				negocioCotizacion.getCotizacionesExpedeinteMantenimiento(), app);
		this.app = app;
	}
	...
	public void onEvent(Event event) throws Exception {
		try {
			...
			if (accion <= Accion.CONSULTAR || accion == Accion.ANULAR
				...
				new ContCotizacionExpediente(accion, cotizacion, this, this.app);
	...
	public void imprimir(Cotizacion cotizacion) {
		try {
			...
			reporte.setSrc("reportes/CotizacionServicioTecnico.jasper");
