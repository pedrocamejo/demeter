...
public class UiBanco extends CompVentanaBase<Banco> {
	...
	public UiBanco(String titulo, int ancho) throws ExcDatosInvalidos {
		super(titulo, ancho);
	}

	public UiBanco(String titulo) throws ExcDatosInvalidos {
		super(titulo);
