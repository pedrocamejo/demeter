package cpc.demeter.comando.ministerio;
...
import cpc.demeter.catalogo.ContArticulosVenta;
import cpc.demeter.catalogo.ContCostosBancarios;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoCostoBancario implements IComando {
	...
	public void ejecutar() {
		try {
			ContCostosBancarios servicio = new ContCostosBancarios(
					getAccionFuncionalidad(), (AppDemeter) app);
			// ContCrearRespaldoDB serivicio = new ContCrearRespaldoDB(1, app);
