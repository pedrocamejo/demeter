...
public class UIFabricante extends CompVentanaBase<Fabricante> {
	...
	public UIFabricante(String titulo, int ancho, AppDemeter app) {
		super(titulo, ancho);
		this.app = app;
	}

	public void cargarValores(Fabricante arg0) throws ExcDatosInvalidos {
