...
import cpc.demeter.controlador.gestion.ContPrestamoActivo;
...
public class ContPrestamosActivos extends ContCatalogo<TrasladoActivo>
	...
	public ContPrestamosActivos(AccionFuncionalidad accionesValidas,
		...
		this.app = app;
		dibujar(accionesValidas, "PRESTAMOS	DE ACTIVOS",
				negocio.obtenerPrestamos(), app);
	...
	public void onEvent(Event event) throws Exception {
		try {
			...
			if (accion <= Accion.CONSULTAR || accion == Accion.ANULAR) {
				TrasladoActivo prestamo = getDatoSeleccionado();
				if (prestamo == null && accion != Accion.AGREGAR)
					app.mostrarError("Seleccione un Prestamo del Catalogo");
				else
					new ContPrestamoActivo(accion, prestamo, this, app);
			}
