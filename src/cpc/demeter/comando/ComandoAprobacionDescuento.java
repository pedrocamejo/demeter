...
import cpc.demeter.catalogo.ContAprovacionesDescuentos;
import cpc.demeter.catalogo.ContCierresDiarios;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoAprobacionDescuento implements IComando {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6317847199885739485L;
	...
	public void ejecutar() {
		try {
			ContAprovacionesDescuentos servicio = new ContAprovacionesDescuentos(
