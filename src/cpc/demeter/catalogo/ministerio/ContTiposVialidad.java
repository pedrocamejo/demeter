...
import cpc.demeter.controlador.ministerio.ContTipoVialidad;
...
public class ContTiposVialidad extends ContCatalogo<TipoVialidad> implements
		EventListener, Serializable {

	private static final long serialVersionUID = -8012014410778713889L;
	private AppDemeter app;

	public ContTiposVialidad(AccionFuncionalidad accionesValidas, AppDemeter app)
		...
		NegocioTipoVialidad servicios = NegocioTipoVialidad.getInstance();
		this.app = app;
		dibujar(accionesValidas, "Tipos Vialidad", servicios.getTodos(), app);
	...
	public void onEvent(Event event) throws Exception {
		try {
			...
			if (accion <= Accion.CONSULTAR) {
				NegocioTipoVialidad servicio = NegocioTipoVialidad
						.getInstance();
				TipoVialidad tipo = getDatoSeleccionado();
				servicio.setModelo(tipo);
				if (tipo == null && accion != Accion.AGREGAR)
					app.mostrarError("Seleccione un tipo de vialidad");
				else
					new ContTipoVialidad(accion, servicio.getModelo(), this,
							app);
			}
	...
	@SuppressWarnings("unchecked")
	public List cargarDato(TipoVialidad tipo) {
