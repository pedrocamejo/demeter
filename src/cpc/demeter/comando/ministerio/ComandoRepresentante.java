...
import cpc.demeter.catalogo.ministerio.ContRepresentantes;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoRepresentante implements IComando {
	...
	public void ejecutar() {
		try {
			ContRepresentantes servicios = new ContRepresentantes(
					getAccionFuncionalidad(), (AppDemeter) app);
			servicios.setIdFuncionalidad(id);
