...
public class UiTipoOrganizacion extends CompVentanaBase<TipoOrganizacion> {
	...
	public UiTipoOrganizacion(String titulo, int ancho)
			throws ExcDatosInvalidos {
		super(titulo, ancho);
	}

	public UiTipoOrganizacion(String titulo) throws ExcDatosInvalidos {
		super(titulo);
	...
	@Override
	public void cargarValores(TipoOrganizacion arg0) throws ExcDatosInvalidos {
