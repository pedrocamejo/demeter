...
public class UiTipoUnidadFuncional extends CompVentanaBase<Banco> {
	...
	public UiTipoUnidadFuncional(String titulo, int ancho)
			throws ExcDatosInvalidos {
		super(titulo, ancho);
	}

	public UiTipoUnidadFuncional(String titulo) throws ExcDatosInvalidos {
		super(titulo);
