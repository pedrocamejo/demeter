...
public class ComandoRepuestoEInsumo implements IComando {
	...
	public void ejecutar() {
		try {
			/*
			 * ContRepuestosEInsumos servicio = new
			 * ContRepuestosEInsumos(getAccionFuncionalidad(), (AppDemeter)app);
			 * servicio.setIdFuncionalidad(id);
			 */
			// AppDemeter.getInstancia().getAmbiente().agregarAEscritorio(new
			// VistaReporte());
		} catch (Exception e) {
			e.printStackTrace();
		}
