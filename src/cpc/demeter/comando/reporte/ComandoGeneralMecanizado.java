...
public class ComandoGeneralMecanizado implements IComando, EventListener {
	...
	private CompVentanaDesdeHasta<OrdenTrabajoMecanizado> vistaReporte;

	public void ejecutar() {
		try {
			// mostrarDialogoDeFechas();
			imprimir();
	...
	public void imprimir() {
		try {
			NegocioOrdenTrabajoMecanizado negocio = NegocioOrdenTrabajoMecanizado
					.getInstance();
			/*
			 * Date inicio = vistaReporte.getFechaInicio().getValue(); Date fin
			 * = vistaReporte.getFechaFinal().getValue(); OrdenTrabajoMecanizado
			 * sector = vistaReporte.getOtro().getSeleccion();
			 * //List<OrdenTrabajoMecanizado> planificacion =
			 * negocio.get(inicio, fin, sector);
			 */
			...
			reporte.setSrc("reportes/RepGeneralMecanizado.jasper");
			parametros.put("usuario", app.getUsuario());
