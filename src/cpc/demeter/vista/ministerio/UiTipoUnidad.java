...
public class UiTipoUnidad extends CompVentanaBase<TipoUnidad> {
	...
	public UiTipoUnidad(String titulo, int ancho) throws ExcDatosInvalidos {
		super(titulo, ancho);
	}

	public UiTipoUnidad(String titulo) throws ExcDatosInvalidos {
		super(titulo);
	...
	@Override
	public void cargarValores(TipoUnidad arg0) throws ExcDatosInvalidos {
