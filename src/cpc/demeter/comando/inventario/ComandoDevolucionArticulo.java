...
public class ComandoDevolucionArticulo implements IComando {

	/**
	 * 
	 */
	private static final long serialVersionUID = -772580688819316675L;
	...
	public void ejecutar() {
		...
		try {
			ContDevolucionesArticulos servicio = new ContDevolucionesArticulos(
