...
public class UINotaDebito extends
	...
	public UINotaDebito(String titulo, int ancho, List<DocumentoFiscal> factu,
	...
	public UINotaDebito(NotaDebito modeloIn, String titulo, int ancho)
			throws ExcDatosInvalidos {
		super(titulo, ancho);
		setModelo(modeloIn);
	}
	...
	public void inicializar() {
		setGbEncabezado(1, "");
		setGbDetalle("Detalle Nota Debito");
		setGbPie(2);
		control = new Textbox();
		sede = new Textbox();
		cedula = new Textbox();
	...
	public void dibujar() {
		...
		try {
			setDetalles(cargarLista(desactivarnota), getModelo().getDetalles(),
					encabezadosPrimario());
