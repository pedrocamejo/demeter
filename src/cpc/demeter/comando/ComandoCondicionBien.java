...
public class ComandoCondicionBien implements IComando {

	private static final long serialVersionUID = 3712529404053954217L;
	...
	public void ejecutar() {
		try {
			/*
			 * ContCondicionesBien servicio = new
			 * ContCondicionesBien(getAccionFuncionalidad(), (AppDemeter)app);
