...
public class UiTipoTenenciaTierra extends CompVentanaBase<TipoTenenciaTierra> {
	...
	public UiTipoTenenciaTierra(String titulo, int ancho)
			throws ExcDatosInvalidos {
		super(titulo, ancho);
	}

	public UiTipoTenenciaTierra(String titulo) throws ExcDatosInvalidos {
		super(titulo);
	...
	@Override
	public void cargarValores(TipoTenenciaTierra arg0) throws ExcDatosInvalidos {
