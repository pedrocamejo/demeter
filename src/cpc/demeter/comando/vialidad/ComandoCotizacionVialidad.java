package cpc.demeter.comando.vialidad;
...
import cpc.demeter.catalogo.vialidad.ContCotizacionesVialidad;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoCotizacionVialidad implements IComando {

	private static final long serialVersionUID = -965622162193585174L;
	...
	public void ejecutar() {
		try {
			ContCotizacionesVialidad servicio = new ContCotizacionesVialidad(
