...
import cpc.demeter.catalogo.ministerio.ContUnidadesFuncionales;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoUnidadFuncional implements IComando {
	...
	public void ejecutar() {
		try {
			ContUnidadesFuncionales servicio = new ContUnidadesFuncionales(
