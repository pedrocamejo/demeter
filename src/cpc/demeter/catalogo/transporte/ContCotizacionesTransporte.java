...
public class ContCotizacionesTransporte extends ContCatalogo<CotizacionTransporte> implements
EventListener {
...
/**
	 * 
	 */
	private static final long serialVersionUID = 7143518246318081943L;
private AppDemeter app;
private NegocioCotizacionTransporte negocioCotizacionTransporte;

public ContCotizacionesTransporte(AccionFuncionalidad accionesValidas, AppDemeter app)
...
negocioCotizacionTransporte = NegocioCotizacionTransporte.getInstance();
dibujar(accionesValidas, "COTIZACIONES",
		negocioCotizacionTransporte.getCotizacionestransporte(), app);
this.app = app;
}
...
try {
	...
	if (accion <= Accion.CONSULTAR || accion == Accion.ANULAR
		...
		if (cotizacion == null || accion == Accion.AGREGAR)
			cotizacion = new CotizacionTransporte();
		new ContCotizacionTransporte(accion, cotizacion, this, this.app);
...
@SuppressWarnings("unchecked")
@Override
public List cargarDato(CotizacionTransporte arg0) {
return null;
}
...
String cadena = "";
cadena = cadena + icaro;
CotizacionTransporte ctto = getDatoSeleccionado();
...
public void imprimir(CotizacionTransporte cotizacion) {
try {
	...
	reporte.setSrc("reportes/CotizacionTransporte.jasper");
