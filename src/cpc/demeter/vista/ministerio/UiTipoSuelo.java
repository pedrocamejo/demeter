...
public class UiTipoSuelo extends CompVentanaBase<TipoSuelo> {
	...
	public UiTipoSuelo(String titulo, int ancho) throws ExcDatosInvalidos {
		super(titulo, ancho);
	}

	public UiTipoSuelo(String titulo) throws ExcDatosInvalidos {
		super(titulo);
	...
	@Override
	public void cargarValores(TipoSuelo arg0) throws ExcDatosInvalidos {
