...
public class ComandoMotivoAnulacionSolicitud implements IComando {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8582526544521894104L;
	...
	public void ejecutar() {
		try {
			ContMotivosAnulacionesSolitudes servicio = new ContMotivosAnulacionesSolitudes(
