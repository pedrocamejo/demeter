...
import cpc.demeter.catalogo.ministerio.ContPaises;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoPais implements IComando {
	...
	public void ejecutar() {
		try {
			ContPaises servicio = new ContPaises(getAccionFuncionalidad(),
					(AppDemeter) app);
