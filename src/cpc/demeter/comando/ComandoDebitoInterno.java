...
import cpc.demeter.catalogo.ContDebitosInternos;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoDebitoInterno implements IComando {
	...
	public void ejecutar() {
		try {
			ContDebitosInternos servicio = new ContDebitosInternos(
