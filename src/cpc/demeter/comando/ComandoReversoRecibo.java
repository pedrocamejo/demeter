...
import cpc.demeter.catalogo.ContRecibos;
import cpc.demeter.catalogo.ContReversoRecibos;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoReversoRecibo  implements IComando {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = 7237337929106845514L;
	...
	public void ejecutar() {
		try {
			ContReversoRecibos servicio = new ContReversoRecibos(getAccionFuncionalidad(),
					(AppDemeter) app);
