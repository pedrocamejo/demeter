...
import cpc.demeter.catalogo.gestion.ContSustituciones;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoSustitucion implements IComando {
	...
	public void ejecutar() {
		...
		try {
			ContSustituciones servicio = new ContSustituciones(
