...
import cpc.demeter.catalogo.ministerio.ContTiposVialidad;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoTipoVialidad implements IComando {
	...
	public void ejecutar() {
		try {
			ContTiposVialidad servicio = new ContTiposVialidad(
