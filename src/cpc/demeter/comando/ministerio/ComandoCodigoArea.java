...
public class ComandoCodigoArea implements IComando {

	/**
	 * 
	 */
	private static final long serialVersionUID = 74205570080411847L;
	...
	public void ejecutar() {
		try {
			ContCodigosArea servicio = new ContCodigosArea(
