...
import cpc.demeter.catalogo.transporte.ContCotizacionesSimplesTransporte;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoCotizacionSimpleTransporte implements IComando {
	...
	public void ejecutar() {
		try {
			ContCotizacionesSimplesTransporte servicio = new ContCotizacionesSimplesTransporte(
