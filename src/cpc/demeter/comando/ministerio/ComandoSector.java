...
import cpc.demeter.catalogo.ministerio.ContSectores;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoSector implements IComando {
	...
	public void ejecutar() {
		try {
			ContSectores servicio = new ContSectores(getAccionFuncionalidad(),
					(AppDemeter) app);
