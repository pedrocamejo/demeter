...
import cpc.demeter.controlador.ministerio.ContTipoUnidad;
...
public class ContTiposUnidades extends ContCatalogo<TipoUnidad> implements
		EventListener, Serializable {

	private static final long serialVersionUID = -8012014410778713889L;
	private AppDemeter app;

	public ContTiposUnidades(AccionFuncionalidad accionesValidas, AppDemeter app)
		...
		NegocioTipoUnidad servicios = NegocioTipoUnidad.getInstance();
		this.app = app;
	...
	public void onEvent(Event event) throws Exception {
		try {
			...
			if (accion <= Accion.CONSULTAR) {
				NegocioTipoUnidad servicio = NegocioTipoUnidad.getInstance();
				TipoUnidad unidad = getDatoSeleccionado();
				servicio.setModelo(unidad);
				if (unidad == null && accion != Accion.AGREGAR)
					app.mostrarError("Seleccione un tipo de Unidad");
				else
					new ContTipoUnidad(accion, servicio.getModelo(), this, app);
			}
	...
	@SuppressWarnings("unchecked")
	public List cargarDato(TipoUnidad tipo) {
