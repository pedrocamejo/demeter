...
public class ComandoLibroVentasVsServicosProductos implements IComando, EventListener {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = -4781614632624115136L;
	...
	public void imprimir() {
		try {
			 ...
			 * reporte.setType("pdf"); }
			 */
			List<Object> lista = negocio.getLibrodeventasVsFacturado(inicio, fin);
			...
			reporte.setSrc("reportes/libroVSProductosServicosFacturados.jasper");
