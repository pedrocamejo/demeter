...
import cpc.demeter.catalogo.ministerio.ContUbicacionesFisicas;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoUbicacionFisica implements IComando {
	...
	public void ejecutar() {
		try {
			ContUbicacionesFisicas servicio = new ContUbicacionesFisicas(
