...
import cpc.demeter.catalogo.mantenimiento.ContMomentosFallas;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoMomentoFalla implements IComando {
	...
	public void ejecutar() {
		try {
			ContMomentosFallas servicio = new ContMomentosFallas(
