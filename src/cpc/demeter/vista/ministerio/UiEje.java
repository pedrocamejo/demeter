...
public class UiEje extends CompVentanaBase<UbicacionEje> {
	...
	public UiEje(String titulo, int ancho, List<UbicacionPais> paises)
			throws ExcDatosInvalidos {
		super(titulo, ancho);
		this.paises = paises;
	}

	public UiEje(String titulo) throws ExcDatosInvalidos {
		super(titulo);
	...
	@Override
	public void cargarValores(UbicacionEje arg0) throws ExcDatosInvalidos {
