...
public class ComandoCierreDiario implements IComando {

	private static final long serialVersionUID = -7417645541461397815L;
	...
	public void ejecutar() {
		try {
			ContCierresDiarios servicio = new ContCierresDiarios(
