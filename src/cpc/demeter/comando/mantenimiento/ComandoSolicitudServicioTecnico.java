...
import cpc.demeter.catalogo.mantenimiento.ContMaquinarias;
import cpc.demeter.catalogo.mantenimiento.ContSolicitudesServicioTecnico;
import cpc.zk.componente.interfaz.IZkAplicacion;

//cpc.demeter.comando.mantenimiento.ComandoConsumible
public class ComandoSolicitudServicioTecnico implements IComando {
	...
	public void ejecutar() {
		...
		try {
			ContSolicitudesServicioTecnico servicio = new ContSolicitudesServicioTecnico(
