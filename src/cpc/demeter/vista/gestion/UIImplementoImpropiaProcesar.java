...
public class UIImplementoImpropiaProcesar extends CompVentanaBase<ImplementoImpropio> {
	...
	private Textbox			nombre;
   	...
   	public UIImplementoImpropiaProcesar(String titulo, int ancho, AppDemeter app,int operacion, List estados)
	...
	public void cargarValores(ImplementoImpropio arg0) throws ExcDatosInvalidos {
		...
		unidad.setValue(getModelo().getImplementoUnidad().getUnidad().getDescripcion());
