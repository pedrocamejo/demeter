...
import cpc.demeter.catalogo.mantenimiento.ContSistemas;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoSistema implements IComando {
	...
	public void ejecutar() {
		...
		try {
			ContSistemas servicio = new ContSistemas(getAccionFuncionalidad(),
					(AppDemeter) app);
