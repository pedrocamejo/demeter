...
import cpc.demeter.catalogo.ContSolicitudesExoneracionContrato;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoSolicitudExoneracionContrato  implements IComando  {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1773433408126250574L;
	...
	public void ejecutar() {
		try {
			ContSolicitudesExoneracionContrato servicio = new ContSolicitudesExoneracionContrato(
