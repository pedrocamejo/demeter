...
public class ComandoTrabajoMecanizado implements IComando {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6148639540210231582L;
	...
	public void ejecutar() {
		...
		try {
			ContTrabajosMecanizado servicio = new ContTrabajosMecanizado(
