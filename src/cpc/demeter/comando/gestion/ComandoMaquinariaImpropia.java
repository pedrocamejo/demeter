...
public class ComandoMaquinariaImpropia implements IComando {
	...
	public void ejecutar() {
		try {
			ContMaquinariasImpropias servicio = new ContMaquinariasImpropias(funcionalidades, (AppDemeter) app);
