...
import cpc.demeter.catalogo.gestion.ContEstadosFuncionales;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoEstadoFuncional implements IComando {
	...
	public void ejecutar() {
		...
		try {
			ContEstadosFuncionales servicio = new ContEstadosFuncionales(
