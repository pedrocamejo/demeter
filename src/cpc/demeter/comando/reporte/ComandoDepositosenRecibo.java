...
public class ComandoDepositosenRecibo implements IComando, EventListener {
...
//		vistaReporte.setOtro("tipo",tipo);
		vistaReporte.setTitle("Depositos En Recibos ");
	...
	public void imprimir() {
		try {
			...
			JRDataSource ds = new JRBeanCollectionDataSource(negocio.getDepocitosEnRecibos(inicio, fin));
			app.agregarReporte();
			Jasperreport reporte = app.getReporte();
		
				reporte.setSrc("reportes/DepositosDiaReciboXls.jasper");
