...
import cpc.demeter.catalogo.ContFinanciamientos;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoFinanciamiento implements IComando {
	...
	public void ejecutar() {
		try {
			ContFinanciamientos servicio = new ContFinanciamientos(
