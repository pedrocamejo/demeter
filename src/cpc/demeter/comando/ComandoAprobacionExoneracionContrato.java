...
import cpc.demeter.catalogo.ContAprobacionesExoneracionContrato;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoAprobacionExoneracionContrato  implements IComando  {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -384031761745450257L;
	...
	public void ejecutar() {
		try {
			ContAprobacionesExoneracionContrato servicio = new ContAprobacionesExoneracionContrato(
