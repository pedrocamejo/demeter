...
public class ComandoActivosYMaquinariaEnCampo implements IComando, EventListener {


	/**
	 * 
	 */
	private static final long serialVersionUID = -8712537873179561245L;
		...
		//	parametros.put("logo", Index.class.getResource("/").getPath()+ "../../imagenes/cintillo_inst.png");
			// parametros.put("estado",String , tipo);
				...
				JRDataSource ds = new JRBeanCollectionDataSource(
						negocio.getMaquinariaEimplementoCampo2());
				app.agregarReporte();
				Jasperreport reporte = app.getReporte();
				reporte.setParameters(parametros);
				reporte.setDatasource(ds);
				parametros.put("exportParameter", app.getXLSParameters(false));
				reporte.setSrc("reportes/ActivosMaquinariaImplementosEnCampo.jasper");
				reporte.setType("xls");
