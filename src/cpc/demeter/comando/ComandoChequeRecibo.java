...
import cpc.demeter.catalogo.ContChequesRecibos;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoChequeRecibo implements IComando {
	...
	public void ejecutar() {
		try {
			ContChequesRecibos servicio = new ContChequesRecibos(getAccionFuncionalidad(),
					(AppDemeter) app);
