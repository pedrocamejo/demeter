...
import cpc.demeter.catalogo.ContAprobacionDebitosInternos;
import cpc.demeter.catalogo.ContAprobacionReversoRecibos;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoAprobacionDebitoInterno implements IComando {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7723228156567776821L;
	/**
	 * 
	 */
	...
	public void ejecutar() {
		try {
			ContAprobacionDebitosInternos servicio = new ContAprobacionDebitosInternos(
