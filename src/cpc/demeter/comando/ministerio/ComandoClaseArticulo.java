...
import cpc.demeter.catalogo.ContClasesArticulos;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoClaseArticulo implements IComando {
	...
	public void ejecutar() {
		try {
			ContClasesArticulos servicios = new ContClasesArticulos(
