...
public class UILote extends CompVentanaBase<Lote> {
	...
	public UILote(String titulo, int ancho, AppDemeter app) {
		super(titulo, ancho);
		this.app = app;
	}

	public void cargarValores(Lote arg0) throws ExcDatosInvalidos {
