...
public class ContCotizacionEquipo extends ContVentanaBase<Cotizacion> implements
		EventListener {
	...
	public ContCotizacionEquipo(int modoOperacion, Cotizacion cotizacion,
		...
		setDato(cotizacion);
		setear(cotizacion, new UICotizacionExpediente("Cotizacion de Equipos", 800,
...
/*
	...
	public void guardar() throws ExcFiltroExcepcion {
		...
		getDato().setTipoCotizacion(negocioCotizacion.getEquipos());
