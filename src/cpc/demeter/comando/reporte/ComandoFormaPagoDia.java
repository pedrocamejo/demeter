...
public class ComandoFormaPagoDia implements IComando, EventListener {
	...
	public void menuImprimir() throws ExcFiltroExcepcion {
		...
		vistaReporte.setTitle("Formas De Pago En Recibos");
	...
	public void imprimir() {
		try {
			...
			lista.add(negocio.getReporteFormasPago(inicio, fin));
			...
			reporte.setSrc("reportes/FormasdepagoDiaXls.jasper");
