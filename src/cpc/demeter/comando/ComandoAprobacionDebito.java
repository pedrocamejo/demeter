...
import cpc.demeter.catalogo.ContAprovacionesDebitos;
import cpc.zk.componente.interfaz.IZkAplicacion;

public class ComandoAprobacionDebito implements IComando {
	...
	public void ejecutar() {
		try {
			ContAprovacionesDebitos servicio = new ContAprovacionesDebitos(
