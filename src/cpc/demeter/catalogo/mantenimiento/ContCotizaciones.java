...
public class ContCotizaciones extends ContCatalogo<Cotizacion> implements
	...
	public ContCotizaciones(AccionFuncionalidad accionesValidas, AppDemeter app)
		...
		dibujar(accionesValidas, "COTIZACIONES",
				...
				negocioCotizacion.getCotizacionesExistencia(),  app);
	...
	public void onEvent(Event event) throws Exception {
		try {
			...
			if (accion <= Accion.CONSULTAR || accion == Accion.ANULAR
				...
				new ContCotizacion(accion, cotizacion, this, this.app);
