...
import cpc.demeter.vista.ministerio.UiTipoVialidad;
...
public class ContTipoVialidad extends ContVentanaBase<TipoVialidad> {

	private static final long serialVersionUID = 6184414588153046382L;
	private NegocioTipoVialidad servicio;
	private AppDemeter app;
	private UiTipoVialidad vista;

	public ContTipoVialidad(int modoOperacion, TipoVialidad tipo,
			ContTiposVialidad llamador, AppDemeter app)
		...
		try {
			...
			setear(tipo, new UiTipoVialidad("VIALIDAD ("
					+ Accion.TEXTO[modoOperacion] + ")", 550), llamador, app);
			vista = ((UiTipoVialidad) getVista());
	...
	public void eliminar() {
		...
		try {
			servicio = NegocioTipoVialidad.getInstance();
