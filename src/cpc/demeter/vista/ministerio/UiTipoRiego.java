...
public class UiTipoRiego extends CompVentanaBase<TipoRiego> {
	...
	public UiTipoRiego(String titulo, int ancho) throws ExcDatosInvalidos {
		super(titulo, ancho);
	}

	public UiTipoRiego(String titulo) throws ExcDatosInvalidos {
		super(titulo);
	...
	@Override
	public void cargarValores(TipoRiego arg0) throws ExcDatosInvalidos {
