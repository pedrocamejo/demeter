...
import cpc.demeter.catalogo.transporte.ContOrdenesTrabajoTransporteInterno;
import cpc.zk.componente.excepciones.ExcColumnasInvalidas;
import cpc.zk.componente.interfaz.IZkAplicacion;
import cva.pc.demeter.excepciones.ExcArgumentoInvalido;
import cva.pc.demeter.excepciones.ExcFiltroExcepcion;

public class ComandoOrdenTransporteInterno implements IComando {


	/**
	 * 
	 */
	private static final long serialVersionUID = -3985680973263623339L;
	...
	public void ejecutar() {
		...
		try {
			ContOrdenesTrabajoTransporteInterno servicio = new ContOrdenesTrabajoTransporteInterno(
