...
public class ComandoConsolidadoMecanizado implements IComando, EventListener {
	...
	public void menuImprimir() throws ExcFiltroExcepcion {
		...
		vistaReporte.setTitle("Consolidado Mecanizado");
	...
	public void imprimir() {
		try {
			...
			JRDataSource ds = new JRBeanCollectionDataSource(
					negocio.getReporteConsolidado(inicio,fin));
			app.agregarReporte();
			Jasperreport reporte = app.getReporte();
			reporte.setSrc("reportes/reporteConsolidado.jasper");
